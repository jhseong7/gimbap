...
When I started my journey with Go in early 2024, I was impressed by Go's strengths, but at the same time disappointed by the lack of a comprehensive framework to build web applications such as Spring in Java, NestJS in Node.js, or Django in Python.

Although Go gives you more control over low-level details compared to Java, Node.js, or Python, it was still challenging to write enterprise-level web applications.
...
This is how GIMBAP started.

<img src="./gimbap-logo.png" width="2rem" />
